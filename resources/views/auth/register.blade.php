...
<div class="container ">
    <div class="row justify-content-center row d-flex justify-content-center align-items-center h-100">
        <div class="col-md-8 ">
            <div class="card bg-dark text-white">
                <div class="card-header text-white border-white">{{ __('Register') }}</div>
                <div class="card-body ">
